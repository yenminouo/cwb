...
plot(jul$代溃,type="b", pch=16, col="black",las=1,xlab="ら戳",ylab="溃",main="2017/07", axes=TRUE)
plot(aug$代溃,type="b", pch=16, col="black",las=1,xlab="ら戳",ylab="溃",main="2017/08", axes=TRUE)
plot(sep$代溃,type="b", pch=16, col="black",las=1,xlab="ら戳",ylab="溃",main="2017/09", axes=TRUE)
