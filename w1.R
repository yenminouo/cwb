...
plot(jul$代溃,type="o", pch=16, col="black",las=1,xlab="ら戳",ylab="溃",main="2017/07", axes=TRUE)
plot(aug$代溃,type="o", pch=16, col="black",las=1,xlab="ら戳",ylab="溃",main="2017/08", axes=TRUE)
plot(sep$代溃,type="o", pch=16, col="black",las=1,xlab="ら戳",ylab="溃",main="2017/09", axes=TRUE)
plot(oct$代溃,type="o", pch=16, col="black",las=1,xlab="ら戳",ylab="溃",main="2017/10", axes=TRUE)
plot(nov$代溃,type="o", pch=16, col="black",las=1,xlab="ら戳",ylab="溃",main="2017/11", axes=TRUE)
plot(dec$代溃,type="o", pch=16, col="black",las=1,xlab="ら戳",ylab="溃",main="2017/12", axes=TRUE)
