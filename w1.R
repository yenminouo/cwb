...
plot(oct$代溃,type="b", pch=16, col="black",las=1,xlab="ら戳",ylab="溃",main="2017/10", axes=TRUE)
plot(nov$代溃,type="b", pch=16, col="black",las=1,xlab="ら戳",ylab="溃",main="2017/11", axes=TRUE)
plot(dec$代溃,type="b", pch=16, col="black",las=1,xlab="ら戳",ylab="溃",main="2017/12", axes=TRUE)
